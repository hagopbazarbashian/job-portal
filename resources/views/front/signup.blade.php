@extends('front.layout.app') @section('main_content') @section('seo_title'){{$pageotheritem->signup_page_title}}@endsection @section('meta_description'){{$pageotheritem->signup_page_meta_description}}@endsection
...
<div class="page-top" style="background-image: url('uploads/banner.jpg');">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{{$pageotheritem->signup_page_heading}}</h2>
            </div>
        </div>
    </div>
</div>
